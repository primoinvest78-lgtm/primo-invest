...
export default async function ClientesPage() {
  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-col gap-4 rounded-2xl border border-secondary-foreground/10 bg-secondary p-5 shadow-card-lg md:flex-row md:items-end md:justify-between md:p-6">
